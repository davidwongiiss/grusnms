...
public class XmlParser {
	public static GbeValue gbeXmlParser(Document document, com.grus.nms.daemon.monitor.nsg9000.pojo.Node deviceNode)
			throws Exception {
	 ...
	 * @throws Exception
	 */
	public static QamValue qamXmlParser1(Document document, com.grus.nms.daemon.monitor.nsg9000.pojo.Node deviceNode)
			throws Exception {
		...
		for (int i = 0; i < list.getLength(); i++) {
			...
			if (Long.parseLong(node.getNodeValue()) - ((blade - 1) * 16) == 1) {
				...
				qam.setQam1(true);//true/*map.getNamedItem("Enabled").getNodeValue().toString().equals("1")*/);
				...
				Node multicastBitrate = map.getNamedItem("Bitrate");
				Node numOfServices = map.getNamedItem("NumOfServices");
				qam.setQam2(true);//(true/*map.getNamedItem("Enabled").getNodeValue().toString().equals("1")*/);
				...
				Node multicastBitrate = map.getNamedItem("Bitrate");
				Node numOfServices = map.getNamedItem("NumOfServices");
				qam.setQam3(true);//(true/*map.getNamedItem("Enabled").getNodeValue().toString().equals("1")*/);;
				...
				Node multicastBitrate = map.getNamedItem("Bitrate");
				Node numOfServices = map.getNamedItem("NumOfServices");
				qam.setQam4(true);//(true/*map.getNamedItem("Enabled").getNodeValue().toString().equals("1")*/);
				...
				Node multicastBitrate = map.getNamedItem("Bitrate");
				Node numOfServices = map.getNamedItem("NumOfServices");
				qam.setQam5(true);//(true/*map.getNamedItem("Enabled").getNodeValue().toString().equals("1")*/);
				...
				Node multicastBitrate = map.getNamedItem("Bitrate");
				Node numOfServices = map.getNamedItem("NumOfServices");
				qam.setQam6(true);//(true/*map.getNamedItem("Enabled").getNodeValue().toString().equals("1")*/);
				...
				Node multicastBitrate = map.getNamedItem("Bitrate");
				Node numOfServices = map.getNamedItem("NumOfServices");
				qam.setQam7(true);//(true/*map.getNamedItem("Enabled").getNodeValue().toString().equals("1")*/);
				...
				Node multicastBitrate = map.getNamedItem("Bitrate");
				Node numOfServices = map.getNamedItem("NumOfServices");
				qam.setQam8(true);//(true/*map.getNamedItem("Enabled").getNodeValue().toString().equals("1")*/);
				...
				Node multicastBitrate = map.getNamedItem("Bitrate");
				Node numOfServices = map.getNamedItem("NumOfServices");
				qam.setQam9(true);//(true/*map.getNamedItem("Enabled").getNodeValue().toString().equals("1")*/);
				...
				Node multicastBitrate = map.getNamedItem("Bitrate");
				Node numOfServices = map.getNamedItem("NumOfServices");
				qam.setQam10(true);//(true/*map.getNamedItem("Enabled").getNodeValue().toString().equals("1")*/);
				...
				Node multicastBitrate = map.getNamedItem("Bitrate");
				Node numOfServices = map.getNamedItem("NumOfServices");
				qam.setQam11(true);//(true/*map.getNamedItem("Enabled").getNodeValue().toString().equals("1")*/);
				...
				Node multicastBitrate = map.getNamedItem("Bitrate");
				Node numOfServices = map.getNamedItem("NumOfServices");
				qam.setQam12(true);//(true/*map.getNamedItem("Enabled").getNodeValue().toString().equals("1")*/);
				...
				Node multicastBitrate = map.getNamedItem("Bitrate");
				Node numOfServices = map.getNamedItem("NumOfServices");
				qam.setQam13(true);//(true/*map.getNamedItem("Enabled").getNodeValue().toString().equals("1")*/);
				...
				Node multicastBitrate = map.getNamedItem("Bitrate");
				Node numOfServices = map.getNamedItem("NumOfServices");
				qam.setQam14(true);//(true/*map.getNamedItem("Enabled").getNodeValue().toString().equals("1")*/);
				...
				Node multicastBitrate = map.getNamedItem("Bitrate");
				Node numOfServices = map.getNamedItem("NumOfServices");
				qam.setQam15(true);//(true/*map.getNamedItem("Enabled").getNodeValue().toString().equals("1")*/);
				...
				Node multicastBitrate = map.getNamedItem("Bitrate");
				Node numOfServices = map.getNamedItem("NumOfServices");
				qam.setQam16(true);//(true/*map.getNamedItem("Enabled").getNodeValue().toString().equals("1")*/);
	 ...
	 * @throws Exception
	 */
	public static List<QamValue> qamXmlParser(Document document, com.grus.nms.daemon.monitor.nsg9000.pojo.Node deviceNode)
			throws Exception {
	...
	public static List<EventValue> eventXmlParser(Document document, com.grus.nms.daemon.monitor.nsg9000.pojo.Node n) throws Exception {
	...
	public static final class Result {
		...
		public static final int QAM = 1;
		public static final int EVENT = 2;

		public Object object;
		public int type;
		
		public Result(Object o, int t) {
			this.object = o;
			this.type = t;
		}
	};
	
	public static List<Result> handleAll(Document document, com.grus.nms.daemon.monitor.nsg9000.pojo.Node node) {
		List<Result> objs = new ArrayList<Result>();
		try {
			objs.add(new Result(gbeXmlParser(document, node), XmlParser.Result.GBE));
			objs.add(new Result(qamXmlParser(document, node), XmlParser.Result.QAM));
			objs.add(new Result(eventXmlParser(document, node), XmlParser.Result.EVENT));			
		}
		catch (Exception e) {
